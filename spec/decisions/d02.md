...
- **Revisit if:** Concrete demand emerges (large-file relay, SSE, media proxying). Enabler work: choose a streaming trait, build the Fastly select-scheduler (D3 revisit — *planned*), adapt the Fastly handle to the trait, map CF `ReadableStream`.
