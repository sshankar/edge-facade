...
- **Rationale:** Each refinement resolves a concrete collision or lifetime issue found while implementing M0 (see [milestones/m0 §5](../milestones/m0.md) for details).
