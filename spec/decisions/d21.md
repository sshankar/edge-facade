...
- **Revisit if:** streaming request bodies (upload) or concurrent streams are needed — both require the M7 wake-capable executor (`SPEC-PORTABILITY-PRIMITIVES.md` §4.1 — `portability/time-deadlines` *planned*) and `send_async_streaming` wiring.
